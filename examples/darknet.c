...
int main(int argc, char **argv)
{
    ...
    //test_convolutional_layer();
		...
		char *cfg = "./cfg/tiny.cfg";

		char *weights = "./tiny.weights";

		char *data = "./data/person.jpg";
		// 传入数据是指针
		predict_classifier("cfg/imagenet1k.data", cfg, weights, data, 5);
//    if(argc < 2){
...
//#else
//    if(gpu_index >= 0){
//        cuda_set_device(gpu_index); // 设置gpu型号, 这里仅仅支持单个gpu
//    }
//#endif
//
